...
const BackgroundAnimation = () => (
	<div className='w-8/12 md:w-6/12 lg:w-4/12 absolute right-0 md:right-12 lg:right-28 top-32 flex justify-center items-center text-secondary'>
		...
		>
			...
			<defs>
				...
				>
					...
					<stop offset='1' stopColor='#383B40' stopOpacity='0' />
				</radialGradient>
				<radialGradient
					id='paint1_radial'
					cx='0'
